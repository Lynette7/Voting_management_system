					...
					<div class="card-footer">
						<div class="row">
							<div class="buttons">
								...
								<button class="cancel" type="button" onclick="$('#manage-voting').get(0).reset()"> Cancel</button>
							</div>
						</div>
					</div>
				</div>
							...
							<tbody>
								...
								<tr>
									...
									<?php elseif($row['is_default'] == 0):  ?>
										<td class="text-center"><div class="update_default" data-id="<?php echo $row['id'] ?>">No</div></td>
									<?php endif; ?>
									<td class="text-center">
										<button class="edit_voting" type="button" data-id="<?php echo $row['id'] ?>">Edit</button>
										<button class="delete_voting" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
